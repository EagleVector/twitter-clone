					...
					<div className='flex justify-between items-center'>
						<div className='flex gap-4 mt-2 text-sm text-gray-400'>
						...
						</div>
							{
								...
								<>
									{amIFollowing ? (
										<button onClick={handleUnfollowUser} className='bg-[#1d9bf0] text-white px-4 py-2 rounded-full text-md'>
											Unfollow
										</button>
									) : (
										<button onClick={handleFollowUser} className='bg-[#1d9bf0] text-white px-4 py-2 rounded-full text-md'>
											Follow
										</button>
									)}
								</>
